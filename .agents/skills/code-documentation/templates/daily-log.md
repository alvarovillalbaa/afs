...
Development logs go in `logs/YYYY/MM-DD/changes.md` — always append to the latest existing file, never create new files unless today's date directory doesn't exist yet.
